...
//  }
  ...
  // if (this->connectionManager->radio->handShakeSucceeded == true)
  // {
  //   this->connectionManager->radio->listenToRegisteredRadioDevice(this->connectionManager->pendingDevice);
  // }
