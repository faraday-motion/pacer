...
class Pwm_controller : virtual public Input_controller
{
private:
  FMV *mFMV;
...
public:
  Pwm_controller(byte id, FMV *fmv, Pwm_controller_config* cfg = nullptr) : Input_controller(id, Modules::PWM_CONTROLLER)  {
    mFMV = fmv;
    if (cfg == nullptr)
